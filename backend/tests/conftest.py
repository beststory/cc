...
def sample_course():
    ...
    return Course(
        ...
        lessons=[
            Lesson(lesson_number=1, title="MCP 소개", lesson_link="https://example.com/lesson1"),
            Lesson(lesson_number=2, title="서버 설정", lesson_link="https://example.com/lesson2"),
            Lesson(lesson_number=3, title="도구 구현", lesson_link="https://example.com/lesson3")
        ]
    )
...
@pytest.fixture 
def mock_vector_store_with_data(mock_vector_store, sample_search_results, sample_course):
